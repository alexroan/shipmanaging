...
${OBJECTDIR}/file_handler.o: file_handler.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -fast -g -o ${OBJECTDIR}/file_handler.o file_handler.c

${OBJECTDIR}/linked_list.o: linked_list.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -fast -g -o ${OBJECTDIR}/linked_list.o linked_list.c

${OBJECTDIR}/simulator.o: simulator.c 
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.c) -fast -g -o ${OBJECTDIR}/simulator.o simulator.c
